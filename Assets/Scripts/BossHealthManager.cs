...
public class BossHealthManager : MonoBehaviour
{
    ...
    void Update()
    {
        if (enemyHealth <= 0)
        {
            ...
            {
                GameObject clone1 = Instantiate(bossPrefab, new Vector3(transform.position.x + 3f, transform.position.y, transform.position.z), transform.rotation) as GameObject;
